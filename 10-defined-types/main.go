...
type (
	age        int // new type, int is the underlying type
	oldAge     age // new type, int (not age) is the underlying type
	veryOldAge age // new type, int (not age) is the underlying type
)
