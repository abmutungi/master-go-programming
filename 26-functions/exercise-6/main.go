...
The function should search for the string (the second parameter) in the slice (the first parameter)
and returns true if it finds the string in the slice and false otherwise. Do function does an case-sensitive search.
...
func main() {
	animals := []string{"lion", "tiger", "bear"}
	result := searchItem(animals, "tiger")
